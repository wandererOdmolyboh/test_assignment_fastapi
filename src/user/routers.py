...
from src.auth.oauth2 import oauth2_schema, validate_token_from_headers
...
async def create_user(user: UserCreate, db: AsyncSession = Depends(get_async_session), user_id=Depends(validate_token_from_headers)):
    """
